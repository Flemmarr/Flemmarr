...
#                         updated_mapping[k][k2] = AppSettingList(v2, resource=f"/{k}/{k2}", api=api)
...
#                 updated_mapping[k] = AppSettingList(v, resource=f"/{k}", api=api)
...
def main():
    ...
    cfg = parse_config("template.yml", default_value='')
